...
public class Fenetre extends JFrame {
    ...
    private JButton bouton_cap3 = new JButton("Capteur 3");
    ...
    private JComboBox<String> connect_combo1 = new JComboBox<String>();
    private JLabel connect_label1 = new JLabel();

    private JComboBox<String> connect_combo2 = new JComboBox<String>();
    private JLabel connect_label2 = new JLabel();

    private JComboBox<String> connect_combo3 = new JComboBox<String>();
    private JLabel connect_label3 = new JLabel();


    // --- FENETRE ---
    public Fenetre() {
        setTitle("I'M JUST A F***ING KID!!");
        ...
        bouton_cap3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                /*label.setText("Vous avez cliqué sur le bouton numero 1");
                conteneur.add(label, BorderLayout.SOUTH); ICI METTRE COMMANDE DEMANDE VALEUR */
            }
        ...
        filtre_combo.addItem("Capteur 3");
        ...
        connect_combo1.addItem("Off");
        connect_combo1.addItem("On");

        connect_label2.setText("Capteur 2 :");
        connect_combo2.addItem("Off");
        connect_combo2.addItem("On");

        connect_label3.setText("Capteur 3 :");
        connect_combo3.addItem("Off");
        connect_combo3.addItem("On");
        

        connect_combo1.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    /*label1.setText("Vous avez sélectionné le " + e.getItem());
                    conteneur.add(label1, BorderLayout.PAGE_END); ICI METTRE COMMANDE RMI */
                }
            }
        });

        connect_combo2.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    /*label1.setText("Vous avez sélectionné le " + e.getItem());
                    conteneur.add(label1, BorderLayout.PAGE_END); ICI METTRE COMMANDE RMI */
        ...
        connect_combo3.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    /*label1.setText("Vous avez sélectionné le " + e.getItem());
                    conteneur.add(label1, BorderLayout.PAGE_END); ICI METTRE COMMANDE RMI */
        ...
        SUD.add(connect_combo1);
        SUD.add(connect_label2);
        SUD.add(connect_combo2);
        SUD.add(connect_label3);
        SUD.add(connect_combo3);
